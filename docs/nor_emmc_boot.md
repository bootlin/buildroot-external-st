...
to follow the new emplacement of the U-boot environment in the NOR memory.
...
Then flash the board as explain in the [STM32Cube programmer doc](docs/stm32cubeprogrammer.md)
...
support enabled. Please look at commits 2157a74 ("board/st/dts/mp257f-ev1-mx: Add support for missing SPI nor description")
