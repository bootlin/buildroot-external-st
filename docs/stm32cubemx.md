...
- The rcc node configuration. You need to fix it by copying the rcc
  node from TF-A. See commit [8c8fe33](https://github.com/bootlin/buildroot-external-st/commit/8c8fe33756834dc01e812c2823ff612aef79b518)
  to view the change needed on the devicetree.

- In the `sdmmc1/2` nodes the `vddsd1/2-supply` parameters are missing.
  You need to fix by adding these parameters. See commit
  [d0bdfba](https://github.com/bootlin/buildroot-external-st/commit/d0bdfba1f758cb9a56a79217718666160dba1db7)
  to view the change needed on the devicetree.
