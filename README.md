...
| OpenGL  | No | No | Yes | Yes | No | Yes | No | Yes | No | Yes |
| WiFi    | N/A | No | N/A | Yes | No | Yes | N/A | N/A | N/A | Yes |
...
with this `BR2_EXTERNAL` tree, and more precisely its `st/2024.02.8`
branch.

```bash
$ git clone -b st/2024.02.8 https://github.com/bootlin/buildroot.git
```
...
```bash
$ git clone -b st/2024.02.8 https://github.com/bootlin/buildroot-external-st.git
```
