...
with this `BR2_EXTERNAL` tree, and more precisely its `st/2023.02.6`
branch.

```bash
$ git clone -b st/2023.02.6 https://github.com/bootlin/buildroot.git
```
...
```bash
$ git clone -b st/2023.02.6 https://github.com/bootlin/buildroot-external-st.git
```
